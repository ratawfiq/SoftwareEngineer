...
function display(){
	createTables("table1", "completed", localStorage.storedUsername);
...
function createTables(tableNum, orderStatus, username){
	...
	if (tableNum=="table1"){
		...
		//Creating the table
			...
			var actualDeliveryTime_cell=row.insertCell(2);
			...
			actualDeliveryTime_cell.innerHTML=actualDeliveryTime;
...
function moreInfo(ID){
	...
	for (var i=0; i<len; i++){
		...
		"<br/>Actual Delivery Time: "+actualDeliveryTime+
